...
export default function DocumentsPage() {
  ...
  const handleDeceasedRelationshipSelect = (selected: DeceasedRelationship) => {
    ...
    // 100만원 이하이고 형제자매 선택 시 선순위 상속인 확인
      ...
      navigateToStep(70); // 형제자매 100만원 이하 케이스: 선순위 상속인 확인
    }
  ...
  const handleSpouseCheck = (hasSpouseValue: boolean) => {
    ...
    // 배우자는 공동상속인이 될 수 있으므로, 배우자 유무와 관계없이 자녀 확인으로 이동
  ...
  return (
    <div className="h-screen bg-gray-100 flex flex-col overflow-hidden">
      ...
      <main className="flex-1 flex flex-col px-6 pt-4 pb-4 overflow-hidden">
              ...
              <div ref={captureRef} style={{ backgroundColor: '#ffffff' }}>
                <div style={{
                  ...
                  <h1 style={{
                    ...
                    marginBottom: '24px',
                    textAlign: 'center'
                  }}><span style={{ display: 'block' }}>본인부담상한제</span><span style={{ display: 'block' }}>　환급금 신청 안내</span></h1>
        ...
        {/* STEP 70: 선순위 상속인(자녀/배우자) 확인 (형제자매 100만원 이하) */}
        ...
        {/* STEP 71: 형제자매 100만원 이하 결과 (선순위 상속인 없음) */}
