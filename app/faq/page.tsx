  ...
  const faqs: FAQ[] = [
    {
      ...
      note: "다만, 환급 기간(매년 8~9월)처럼 접수 건수가 갑자기 몰리는 시기에는 조금 더 시간이 걸릴 수 있으니 너그러운 마음으로 기다려 주세요!",
    },
    {
      id: 2,
      iconBg: "bg-amber-50",
    ...
    },
    {
      ...
      note: "THE건강보험 앱 > 민원여기요 > 조회 > 환급금 조회/신청 > 상한제 사후환급금 조회 메뉴에서 직접 내역을 캡처해 주세요.",
    },
    {
      id: 5,
      iconBg: "bg-rose-50",
      ...
      note: "개인별 상한액 기준보험료 및 상한액을 매년 8월 경 확정하므로 미리 계산할 수 없습니다.",
    },
  ];
